...
urlpatterns = [
    ...
    url(
        r"^tickets/check_out/(?P<ticket_pk>\d+)$",
        api.ticket_check_out,
        name="ticket_check_out",
    ),
    url(
        r"^tickets/check_in_by_token$",
        api.ticket_check_in_by_token,
        name="ticket_check_in_by_token",
    ),
]
