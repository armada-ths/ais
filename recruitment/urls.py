...
urlpatterns = [
    ...
    url(r'^application/(?P<pk>\d+)/delete$', views.recruitment_application_delete, name='recruitment_application_delete'),
    url(r'^application/(?P<pk>\d+)$', views.recruitment_application_new, name='recruitment_application_new'),
