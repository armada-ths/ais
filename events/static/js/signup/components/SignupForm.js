                  ...
                  <Grid item sm={12}>
                    ...
                    <Typography>
                      {payed ? (
                          ...
                          <Fragment>
														<Typography style={{marginTop: 8, marginBottom: 8}}>This event has a fee of {event.fee} SEK to sign up. By signing up you agree to THS Armadas <a href="www.google.se">GDPR policy</a>.</Typography>
					...
					{event.fee == 0 && (
	          <Grid item sm={12}>
							<Typography style={{marginTop: 8}}>By signing up you agree to THS Armadas <a href="www.google.se">GDPR policy</a>.</Typography>
	            <Button
