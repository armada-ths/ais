...
urlpatterns = patterns(
    ...
    url(
        r"^stacked/$",
        "formset",
        {"formset_class": ContactFormset, "template": "example/formset-stacked.html"},
        name="example_stacked",
    ),
    url(
        r"^table/$",
        "formset",
        {"formset_class": ContactFormset, "template": "example/formset-table.html"},
        name="example_table",
    ),
    url(
        r"^form-template/$",
    ...
    url(
        r"^inline-formset/$",
        "inline_formset",
        {"form_class": OrderedItemForm, "template": "example/inline-formset.html"},
        name="example_inline_formset",
    ),
    url(
        r"^inline-formset-autocomplete/$",
        "inline_formset",
        {
