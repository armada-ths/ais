...
def send_CR_confirmation_email(signature, deadline):
    html_message = '''
		<html>
        	<body>
        		...
        		<div>
        		      Thank you for submitting the complete registration for THS Armada 2020. The complete registration contract was signed by %s on the %s for %s.
                      <br/><br/>
    ...
    plain_text_message = '''Thank you for submitting the complete registration for THS Armada 2020. The complete registration contract was signed by %s on the %s for %s.
...
''' % 	(
    ...
    email = EmailMultiAlternatives(
        'Complete registration for THS Armada 2020',
        plain_text_message,
        'noreply@armada.nu',
