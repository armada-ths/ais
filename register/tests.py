...
class OrderLogTestCase(TestCase):
    def test(self):
        ...
        fair2 = Fair.objects.create(
            name="fair2", year=2016, description="description2", current=False
        )
        user1 = User.objects.create_user(
            username="john", email="jlennon@beatles.com", password="glass onion"
        )
        user2 = User.objects.create_user(
            username="paul", email="paul@beatles.com", password="glass onion"
        )

        company = Company.objects.create(
            name="TestCompany1 for testing", organisation_type="company"
        )
        ...
        contact2 = Contact.objects.create(
            user=user2,
            belongs_to=company2,
            name="contact name 2 for testing",
