...
Continent, StudentAnswerRegion, StudentAnswerContinent, SwedenCities
...
class SwedenCitiesAdmin(admin.ModelAdmin):
    model = SwedenCities
...
admin.site.register(SwedenCities, SwedenCitiesAdmin)
