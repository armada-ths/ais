...
from .models import Question, Response, Answer, TextAns, ChoiceAns, IntegerAns, BooleanAns
...
class ResponseForm(ModelForm):
    ...
    def add_question(self, question, data):
        ...
        self.fields['question_%d' % question.pk] = field ## VERY IMPORTANT TO KEEP question_%d here. Other code is dependant on it
