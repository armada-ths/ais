...
COPY ./apps/complete_registration/output.css ./apps/complete_registration/build/index.css
...
COPY --from=frontend-dashboard /usr/src/app/apps/complete_registration/build ./ais_static/apps/complete_registration
