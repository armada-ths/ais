...
urlpatterns = [
	...
	url(r'^dietary-restrictions$', views.admin_dietary_restrictions, name = 'unirel_admin_dietary_restrictions'),
	url(r'^new$', views.admin_participant_form, name = 'unirel_admin_participant_new'),
	url(r'^(?P<participant_pk>[0-9]+)/delete$', views.admin_participant_delete, name = 'unirel_admin_participant_delete'),
