...
def exhibitor(request, exhibitor, company):
	...
	return OrderedDict([
		...
		('logo_squared', absolute_url(request, exhibitor.catalogue_logo_squared) if exhibitor.catalogue_logo_squared else None),
		('logo_freesize', absolute_url(request, exhibitor.catalogue_logo_freesize) if exhibitor.catalogue_logo_freesize else None),
