    ...
    return (
        <FormWrapper className="flex flex-col gap-y-5 text-slate-700">
            <div className="border-solid border-2 border-slate-300 p-7 text-justify [&>p]:mb-5">
                ...
                <p> You <b>can answer the survey before 29/10 </b>to give the students at one of Europe’s leading technical universities a chance to get to know your values. You are free to skip questions.</p>
