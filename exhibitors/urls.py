...
urlpatterns = [
    ...
    url(r'^confirm_all_orders$', views.NEW_VIEW, name='exhibitors_confirm_all_orders'), # set views.NEW_VIEW
    ...
    # url(r'^(?P<pk>\d+)/confirm_orders$', views.NEW_VIEW, name='exhibitor_confirm_orders'), # set views.NEW_VIEW
